...
/*             function getPartnerId(){//替换partnerid
            ...
            function getPartnerKey(){//替换partnerkey
                return "5514c7a2e139c859d304365d22bba153";
            }
            function getAppId(){//替换appid
                return "wx18d1f38c02bbaaaf";
            }            
            function getAppKey(){//替换appkey
                return "q6AF2J6iP5gk7G4lOF0MmaXiVg9lPV2ANicFHyVXuFE3kzqCnbna8fvn9at9z2AWgwrF54NXSbXWZ71hJxSAuv9L8fF6tRLeorNi9VVMhRJ5f9bxO3VKelQJWwz3WsbT";
            } */
                        //修改到此结束
            //辅助函数
            ...
            function getPackage(){
                var banktype = "WX";
                var body = "text";//商品名称信息，这里由测试网页填入。
                var fee_type = "1"//费用类型，这里1为默认的人民币
                var input_charset = "UTF-8";//字符集，可以使用GBK或者UTF-8
                //生产环境
                var notify_url = "http://tpwxcloud.life.cntaiping.com/wxqhb/wxpay/payback";//支付成功后将通知该地址
                //测试环境
